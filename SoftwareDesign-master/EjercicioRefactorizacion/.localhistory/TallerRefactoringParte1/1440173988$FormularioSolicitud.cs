...
namespace TallerRefactoringParte1 {
    ...
    public class ArchivoAdjunto {
        public struct MimeTypeInfo {
            ...
            protected internal MimeTypeInfo(string Extension, string MimeType) {
        ...
        private static MimeTypeInfo[] _FormatosValidos = { 
                                                           ...
                                                           new MimeTypeInfo(".txt","application/txt"),
                                                           new MimeTypeInfo(".xls","application/xls"),
                                                           new MimeTypeInfo(".doc","application/doc") 
                                                         };
        ...
        public ArchivoAdjunto(string RutaDelArchivo) {
            ...
            _MimeType = _ObtenerMimeType(RutaDelArchivo);
        ...
        private static bool FormatoEsValido(string RutaDelArchivo) {
            var Extension = Path.GetExtension(RutaDelArchivo);
            var EsValido = false;
